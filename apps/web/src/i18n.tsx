...
const zh: Record<string, string> = {
  ...
  "matchPrep.heroHint": "赛前把接发、拦防、防反和关键分战术放进同一个战术包；临场只需要搜索编号或点击分类。",
  ...
  "matchPrep.shareHeading": "给教练的比赛准备连接",
  ...
  "bench.full": "全场",
  "bench.players": "球员",
  "bench.addOffenseTitle": "点击后在场上放置本方球员，或点击有名字的本方球员替换为普通球员",
  "bench.offense": "本方",
  "bench.addDefenseTitle": "点击后在场上放置对方球员，或点击有名字的对方球员替换为普通球员",
  "bench.defense": "对方",
  ...
  "bench.template": "模板",
  "bench.tipAddOffense": "点击场地放置本方球员；点击有名字的本方球员可替换为普通球员，路线保留。",
  "bench.tipRosterReplace": "点击场上的进攻球员进行替换，跑动路线会保留。",
  "bench.rosterPlayerInUse": "该队员已在场上",
  "bench.tipAddDefense": "点击场地放置对方球员；点击有名字的对方球员可替换为普通球员，路线保留。",
  "bench.tipPassFrom": "点击发球/一传/二传发起者",
  "bench.tipPassTo": "点击接球或进攻球员",
  "bench.tipScreen": "点击设置拦网标记的球员",
  "bench.tipFinish": "先选中进攻球员；点击对方场地添加扣球/吊球落点，点击队友添加保护点。",
  "bench.maxOffense": "本方球员最多 6 人",
  "bench.maxDefense": "对方球员最多 6 人",
  "bench.playerProps": "球员属性",
  "bench.selectPlayerHint": "选择场上球员后，可在这里调整姓名、号码、触球和拦网方向。",
  "bench.playerName": "姓名",
  "bench.playerNumber": "号码",
  "bench.holdBall": "🏐 触球",
  "bench.remove": "移除",
  "bench.screenAngle": "拦网朝向",
  "bench.removeScreen": "移除拦网",
  "bench.finishOptions": "进攻选择",
  "bench.finishEmpty": "点击对方场地添加扣球/吊球落点，或点击队友添加保护点。",
  "bench.finishShot": "落点",
  "bench.finishPass": "保护",
  "bench.finishLabel": "选择名称",
  "bench.finishPriority": "优先级",
  "bench.finishPrimary": "主攻",
  ...
  "tpl.blockDig.desc": "本方并拦压线路，后排防起后快速转换为二号位反击。",
...
const en: Record<string, string> = {
  ...
  "bench.remove": "Remove",
  "bench.screenAngle": "Block Direction",
